...
print(
    f"Quantidade de pessoas com peso superior a 90 kg e altura inferior 1,50 metro: {pesoSuperior90alturaInferior150}m.")
print(
    f"Porcentagem de pessoas com idade entre 10e 30 anos entre as pessoas que medem mais de 1,90 m: {idade10e30Altura190/10*100: . 1f}%.")
